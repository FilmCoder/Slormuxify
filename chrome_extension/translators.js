...
function larmallahOnePointOh(input_text) {
    ...
    function translate(input_text) {
        ...
        var dictionary = {'please':'plix', 'moon':'luneplop', 'dog':'dorgle', 'cat':'catsyprip', 'good':'anime', 'jayanth':'The Borgler', 'sun':'solardix', 'butt':'backborbs', 'ass': 'backborbs', 'milky way':'milkies', 'friends':'beebs', 'hanging out': 'muxin', 'hang out':'mux', 'borgle':'mess up', 'god':'borble','want':'slort'};
        for (word of words) {
